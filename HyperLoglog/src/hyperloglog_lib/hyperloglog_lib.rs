...
// mod custom_error;
// use super::custom_error::PDSAResult as Result;
// IMPORT ALL HELPERS
use crate::hyperloglog_lib::*;
...
impl<T: Hash + Eq> HyperLogLog<T> {
    pub fn new(error_rate: f64) -> PDSAResult<Self> {
        validate(error_rate)?;
...
mod tests {
    ...
    #[test]
    fn test_insertion_with_duplicates() -> PDSAResult<()> {
        let error_rate = 0.01;
